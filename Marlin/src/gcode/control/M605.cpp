...
#include "../../core/debug_out.h"
  ...
  void GcodeSuite::M605() {
    ...
    if (parser.seen("EPS")) {
      ...
      // Bolt: Replaced expensive floating point pow(2, X) with macro _BV(X) to generate the bitmask.
      // This changes a runtime floating point exponentiation to a single bitwise shift CPU instruction.
